 ...
 * Description: Stripe-style client portal and staff app for SiteGuard365.
 * Version: 1.0.0
...
add_action( 'plugins_loaded', array( 'SG365_Loader', 'instance' ) );
register_activation_hook( __FILE__, array( 'SG365_Loader', 'activate' ) );
register_deactivation_hook( __FILE__, array( 'SG365_Loader', 'deactivate' ) );
